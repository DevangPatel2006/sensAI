    ...
    <section className="w-full pt-36 md:pt-48 pb-10">
      <div className="space-y-6 text-center">
        <div className="space-y-6 mx-auto">
          <h1 className="gradient-title text-5xl font-bold md:text-6xl lg:text-7xl xl:text-8xl">Your AI Career Coach for
          <br/>
        ...
        <div className="flex justify-center space-x-4">
            ...
            <Link href="/dashboard">
            <Button size ="lg" className="px-8" variant="outline">Learn More </Button></Link>
        </div>
